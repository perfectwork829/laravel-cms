...
<!--
     <div class="form-group" style='display: none;'>
	  <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.Device') }}
      </label>
...
<!--       @if( $devices_data->device_type=='1' ) (IOS) @elseif( $devices_data->device_type=='2' ) Android @elseif( $devices_data->device_type=='3' ) Other @endif <br>-->
        @endforeach
	  <!--</div>
	</div>
-->
...
<div class="modal-footer">
	...
	<button type="button" class="btn btn-primary" id="send-notificaion">{{ trans('labels.Send') }}</button>
</div>
  {!! Form::close() !!}