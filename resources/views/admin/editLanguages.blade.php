...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ URL::to('admin/listingLanguages')}}"><i class="fa fa-dashboard"></i>{{ trans('labels.ListingAllLanguages') }}</a></li>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
                                    {!! Form::text('code',  $result['languages'][0]->code, array('class'=>'form-control field-validate', 'id'=>'code', 'maxlength'=>'2'))!!}
							...
							<div class="box-footer text-right">
                            	<div class="col-sm-offset-2 col-md-offset-3 col-sm-10 col-md-4">
                                    ...
                                    <a href="{{ URL::to('admin/listingLanguages')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                </div>
							</div>
                              <!-- /.box-footer -->
                            {!! Form::close() !!}
