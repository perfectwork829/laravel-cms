...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="listingTaxRates"><i class="fa fa-dashboard"></i>{{ trans('labels.ListingAllTaxRates') }}</a></li>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
							...
							<div class="box-footer text-center">
								...
								<a href="listingTaxRates" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
							</div>
                              <!-- /.box-footer -->
                            {!! Form::close() !!}
                        </div>
