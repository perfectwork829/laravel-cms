...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ URL::to('admin/listingCoupons')}}"><i class="fa fa-dashboard"></i>All Coupons</a></li>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
							...
							<div class="box-footer text-center">
								...
								<a href="{{ URL::to('admin/listingCoupons')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
							</div>
                              <!-- /.box-footer -->
                            {!! Form::close() !!}
                        </div>
