        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
            	<a href="{{ URL::to('admin/manageAppLabel')}}" type="button" style="display:inline-block; width: auto;" class="btn btn-block btn-primary android-hide">{{ trans('labels.ManageLabels') }}</a>
                  ...
                  @if(count($result['languages'])>0)
                    @foreach ($result['languages'] as $key=>$languages)
                        <tr>
                            ...
                            <td><a data-toggle="tooltip" data-placement="bottom" title=" {{ $languages->name }}" href="editLanguages/{{ $languages->languages_id }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
